// Scoket_Learning_TCP_Client.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
int main()
{
   ...
   {
      printf("Error while connecting server\n");
      WSACleanup();
      return 1;
   }

   if (send(client, "Hello World!", sizeof("Hello World!"), 0) == SOCKET_ERROR)
   {
